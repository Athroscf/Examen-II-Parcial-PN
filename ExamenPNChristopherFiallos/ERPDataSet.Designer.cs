...
namespace ExamenPNChristopherFiallos {
    ...
    public partial class ERPDataSet : global::System.Data.DataSet {
        ...
        public partial class TipoUsuarioDataTable : global::System.Data.TypedTableBase<TipoUsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TipoUsuarioRow AddTipoUsuarioRow(string tipo) {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsuarioRow AddUsuarioRow(string nombre, string apellido, string usuario, string email, System.DateTime fechaCreacion, System.DateTime ultimaConexion, int tipoUsuario, string estado) {
        ...
        public partial class TipoUsuarioRow : global::System.Data.DataRow {
            ...
            public string tipo {
                get {
                    return ((string)(this[this.tableTipoUsuario.tipoColumn]));
                }
                set {
                    this[this.tableTipoUsuario.tipoColumn] = value;
                }
            }
        }
...
namespace ExamenPNChristopherFiallos.ERPDataSetTableAdapters {
    ...
    public partial class TipoUsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuarios].[TipoUsuario] WHERE (([id] = @Original_id) AND ([tipo] = @" +
                "Original_tipo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuarios].[TipoUsuario] ([tipo]) VALUES (@tipo);\r\nSELECT id, tipo FR" +
                "OM Usuarios.TipoUsuario WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Usuarios].[TipoUsuario] SET [tipo] = @tipo WHERE (([id] = @Original_id) A" +
                "ND ([tipo] = @Original_tipo));\r\nSELECT id, tipo FROM Usuarios.TipoUsuario WHERE " +
                "(id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ExamenPNChristopherFiallos.Properties.Settings.Default.ERPConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, tipo FROM Usuarios.TipoUsuario";
        ...
        public virtual int Fill(ERPDataSet.TipoUsuarioDataTable dataTable) {
        ...
        public virtual ERPDataSet.TipoUsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ERPDataSet.TipoUsuarioDataTable dataTable = new ERPDataSet.TipoUsuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ERPDataSet.TipoUsuarioDataTable dataTable) {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Usuarios].[Usuario] WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([usuario] = @Original_usuario) AND ([email] = @Original_email) AND ([fechaCreacion] = @Original_fechaCreacion) AND ([ultimaConexion] = @Original_ultimaConexion) AND ([tipoUsuario] = @Original_tipoUsuario) AND ([estado] = @Original_estado))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ultimaConexion", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ultimaConexion", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Usuarios].[Usuario] ([nombre], [apellido], [usuario], [email], [fechaCreacion], [ultimaConexion], [tipoUsuario], [estado]) VALUES (@nombre, @apellido, @usuario, @email, @fechaCreacion, @ultimaConexion, @tipoUsuario, @estado);
SELECT id, nombre, apellido, usuario, email, fechaCreacion, ultimaConexion, tipoUsuario, estado FROM Usuarios.Usuario WHERE (id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuarios].[Usuario] SET [nombre] = @nombre, [apellido] = @apellido, [usuario] = @usuario, [email] = @email, [fechaCreacion] = @fechaCreacion, [ultimaConexion] = @ultimaConexion, [tipoUsuario] = @tipoUsuario, [estado] = @estado WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([usuario] = @Original_usuario) AND ([email] = @Original_email) AND ([fechaCreacion] = @Original_fechaCreacion) AND ([ultimaConexion] = @Original_ultimaConexion) AND ([tipoUsuario] = @Original_tipoUsuario) AND ([estado] = @Original_estado));
SELECT id, nombre, apellido, usuario, email, fechaCreacion, ultimaConexion, tipoUsuario, estado FROM Usuarios.Usuario WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ultimaConexion", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ultimaConexion", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ultimaConexion", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ultimaConexion", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, nombre, apellido, usuario, email, fechaCreacion, ultimaConexion, tipoU" +
                "suario, estado FROM Usuarios.Usuario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_nombre, string Original_apellido, string Original_usuario, string Original_email, System.DateTime Original_fechaCreacion, System.DateTime Original_ultimaConexion, int Original_tipoUsuario, string Original_estado) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((System.DateTime)(Original_ultimaConexion));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_tipoUsuario));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string nombre, string apellido, string usuario, string email, System.DateTime fechaCreacion, System.DateTime ultimaConexion, int tipoUsuario, string estado) {
            if ((nombre == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(ultimaConexion));
            this.Adapter.InsertCommand.Parameters[6].Value = ((int)(tipoUsuario));
            if ((estado == null)) {
        ...
        public virtual int Update(
                    ...
                    System.DateTime Original_ultimaConexion, 
                    int Original_tipoUsuario, 
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(ultimaConexion));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(tipoUsuario));
            if ((estado == null)) {
                throw new global::System.ArgumentNullException("estado");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[14].Value = ((System.DateTime)(Original_ultimaConexion));
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_tipoUsuario));
            if ((Original_estado == null)) {
                throw new global::System.ArgumentNullException("Original_estado");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    int Original_tipoUsuario, 
                    string Original_estado) {
            return this.Update(nombre, apellido, usuario, email, fechaCreacion, ultimaConexion, tipoUsuario, estado, Original_id, Original_nombre, Original_apellido, Original_usuario, Original_email, Original_fechaCreacion, Original_ultimaConexion, Original_tipoUsuario, Original_estado, Original_id);
        }
    }
